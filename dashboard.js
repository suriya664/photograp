...
function initSidebar() {
    ...
    // Sidebar toggle inside sidebar (for desktop collapse)
    if (sidebarToggle) {
        sidebarToggle.addEventListener('click', function(e) {
            ...
            if (window.innerWidth > 1024) {
                ...
                // On mobile, close sidebar when clicking toggle inside
    ...
    // Mobile sidebar toggle button (always visible on mobile/tablet)
